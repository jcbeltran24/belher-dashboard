window.BELHER = {
  meta: {
    fecha: "Domingo 03 Ago 2026",
    semana: "WK31",
    actualizado: "03/08/2026 · 08:00"
  },

  alertas: [
    {"nivel":"info","texto":"📅 SEMANA WK31 (28-Jul–04-Ago-2026): Off-season monitoreo final. Limón seedless 70ha Belher en cosecha tardía última semana (WK31 cierra 03-Ago domingo). Última operación tomate WK24 (05-Jun). GC 2025–2026 cerrada operacionalmente. Prep GC 2026–2027: semilleras pagadas $984K, WK Calavo estructura 4/4 agosto."},
    {"nivel":"success","texto":"✅ Limón Seedless 110s: rango sostenido $34-36 (ventana estratégica cierre WK31). Belher 70ha bien posicionada — última oportunidad premium pricing esta semana."},
    {"nivel":"info","texto":"📊 WK31–32: Transición post-operacional. Liquidación final Calavo esperada 30-Jul (pasada). WK Calavo pago 1/4 iniciando 15-Ago. Cash flow forecast: monitoreo saldos de tesorería."},
    {"nivel":"info","texto":"🔔 Contrato GC2026-2029: Beltrán-Calavo finales. Cierre esperado antes 15-Jun (pasada) — Mission Produce integración Calavo completada 29-May, acuerdos vigentes."},
  ...
  limon: {
    usda: {
      ...
      historico_12m: [
        ...
        { mes:"Jun 26", nogales_mid:20.0, la_mid:23.0 }
      ],
      tendencia_4s: [
        ...
        { semana:"WK26", nogales_mid:20.0, la_mid:23.0, nota:"Tendencia estable post-junio, Peru supply window cerrando." },
        { semana:"WK30", nogales_mid:20.0, la_mid:23.0, nota:"Off-season WK30: precios USDA sin actualización desde 23-Jun. Monitoreo Peru supply window cerrando WK27-WK31." },
        { semana:"WK31", nogales_mid:20.0, la_mid:23.0, nota:"Off-season WK31: USDA sin actualización desde 23-Jun. Monitoreo Peru supply window cierre final esta semana (WK31 termina 03-Aug)." }
      ]
    },
    temporada: {
      hectareas:        70,
  ...
  ticker: [
    { label:"Tomate Vine-ripe 4x4 (Nogales)", valor:"$11.95-12.95", cambio:"↓57% (off-season)", dir:"down" },
    { label:"Tomate Roma XL 25lb (Nogales)", valor:"$11.95-12.95", cambio:"↓51% (fin temp)", dir:"down" },
    { label:"Chile Bell GH naranja (TX)", valor:"$6.00-7.00", cambio:"↓54%", dir:"down" },
    { label:"Jalapeño (TX)", valor:"$17-19", cambio:"↓47%", dir:"down" },
    { label:"Limón seedless 110s (TX)", valor:"$34-36", cambio:"Estable WK31", dir:"neutral" },
    { label:"AVO (Mission Produce)", valor:"$12.61", cambio:"Jun 6, 2025", dir:"neutral" },
    { label:"CVGW (Calavo→Mission)", valor:"$26.09", cambio:"Jun 19, 2024", dir:"neutral" },
  ...
  industria: [
    { cat:"Mercado",      titulo:"México prioriza supply doméstico de tomate — impacto exportaciones", impacto:"Alto", fuente:"Corbel #0065 · CCO Noticias", resumen:"Gobierno y sector privado acordaron priorizar tomate doméstico ante presión de precios. Vine-ripe Nogales colapsó a $11.95-12.95 en WK24. Off-season permanece." },
  ...
  estrategia: {
    ...
    watchlist: [
      { titulo:"Limón seedless Nogales tendencia", nivel:"Medio", descripcion:"WK18-WK19 spike $36-42 por ventaja supply Peru -30%. Bajío esperado WK24. Belher 70ha bien posicionada si precios mantienen $35-40 WK27-WK31.", accion:"Monitoreo precios y cosecha tardía limón WK27-WK31 — posicionar premium." },
      { titulo:"Roma mercado saturación (Florida expansion)", nivel:"Medio", descripcion:"Florida ha aumentado producción Roma significativamente. España importa Romans a NY premium. Belher final inventory 2.1K (small talla) rotable. Off-season ahora.", accion:"Enfoque GC2026-27 en 4x4/jumbo. Ajustar proyecciones Roma volúmenes." }
    ],
    proximos: [
      { fecha:"2026-08-15", evento:"Inicio ciclo Calavo GC2026-2027 · Pago 1/4 WK", tipo:"Financiero", participantes:"Calavo, Leima", detalles:"WK Calavo estructura 4/4 pagos iniciando agosto. Primer avance capital trabajo." }
    ]
  },

  predicciones: {
    generado:  "03/08/2026 · 08:00",
    modelo:    "Claude Haiku 4.5",
    horizonte: "7 días",
    nota:      "Off-season WK31 final día (03-Aug domingo). Limón 70ha Belher en cosecha tardía última semana WK31 (cierra hoy domingo 03-Aug). Tomate temporada cerrada WK24 (05-Jun). Monitoreo precios Limón Seedless $34-36 Nogales (Peru supply window cierre FINAL esta semana). Sin nuevos reportes operacionales desde 05-Jun. Datos preservados del último reporte; tendencias infieren desde USDA histórico y supply dynamics Peru. Cosecha limón tardía finaliza hoy.",
    items: [
      {
        id: "limon-persa",
        ...
        razonamiento: "Limón 110s $34-36 (Corbel 05-Jun: -15% vs WK23 anterior). Peru supply window cerrando HOJA FINAL esta semana — ventana 2-3 semanas cierra HOY WK31 domingo. Asia-Pacific demand recovery sostenida. 110s premium over 150s sostenido $2-4/carton. WK31 rango estable. Belher 70ha ENTRA COSECHA TARDÍA ÚLTIMA OPERACIÓN hoy domingo 03-Aug en posición estratégica óptima.",
        factores: ["Peru supply window CIERRE FINAL HOY (WK31 termina 03-Aug domingo)", "Asia-Pacific demand recovery", "Belher 70ha competitive supply timing FINAL WK31", "110s premium sostenido $34-36", "Seasonal pricing julio-agosto post-cosecha"],
        riesgo: "Si Peru reabre supply masivamente post-WK31, caída rápida $28-30. Riesgo BAJO HOY último día. Monitoreo diario Corbel crítico próxima semana.",
        accion: "🎯 MAXIMIZAR FOB $34-36 rango ÚLTIMA COSECHA HOY. Priorizar venta 110s premium FINAL OPERACIÓN. HOLD si >$37. Belher 70ha cierre limón = último día cosecha tardía WK31. Coordinar embarques finales hoy domingo."
      },
      {
        id: "vine-ripe",
        producto: "Tomate Vine-ripe 4x4/4x5 (OFF-SEASON CERRADO)",
        unidad: "carton 25lb · FOB Nogales",
        tendencia: "bajista",
        confianza: 85,
        precio_actual: { min:11.95, max:12.95 },
        precio_proyectado: { min:8.00, max:13.50 },
        razonamiento: "Corbel #0065 (05/Jun): Nogales $11.95-12.95 (-57% vs WK23 $28-32). WK31 en pleno off-season para Belher operativamente (última venta 01-Jun). Oferta mexicana masiva junio-julio, demanda post-holiday deprimida. México prioriza supply doméstico. Presión adicional por California GH volumes. Soporte técnico débil. Irrelevante para Belher — temporada operacional cerrada hace 2 meses.",
        factores: ["Off-season total para Belher (cerrado WK24 05-Jun)", "Oferta México masiva junio-julio", "Demanda post-holiday comprimida", "CA GH volumes activos", "Belher: sin operación desde hace 59 días"],
        riesgo: "Información histórica — no aplica a Belher actividad operacional.",
        accion: "⏸️ SIN ACCIÓN: Belher en off-season total. Preparar GC2026-27 con mejores posicionamientos de varietal (4x4/jumbo focus). Monitoreo tendencias para planificación next cycle."
      },
      {
        id: "bell-gh",
        producto: "Chile Bell GH (OFF-SEASON)",
        unidad: "11lb carton Texas",
        tendencia: "lateral",
        confianza: 72,
        precio_actual: { min:6.00, max:7.00 },
        precio_proyectado: { min:5.50, max:8.50 },
        razonamiento: "Chile Bell naranja Texas $6-7 (Corbel 05-Jun: -54% vs WK23). Off-season. Belher Anaheim $26-28 premium posicionamiento fino (último reporte). Mercado lateral probable con soporte $5.50. Sin operación Belher en chile (último shipment 06/05, 59 días atrás).",
        factores: ["Texas GH seasonal excess", "Soporte $5.50 técnico", "Belher Anaheim premium varietal (no en operación)", "Demanda deprimida"],
        riesgo: "No aplica — Belher sin operación desde 06/05.",
        accion: "📋 INFORMACIÓN HISTÓRICA: Monitoreo para GC2026-27 entrada planificada de bell pepper si oportunidad de precio >$12."
      }
    ]
  },
